    ...
    <div class="sys-login">
        <div class="login-area">
            ...
            <div class="lang-toggle">
                ...
                >
                |
                <span :class="{ cur: lang == 'en' }" @click="changeLang('en')"
                    >En</span
                >
            </div>
            <div class="lang-toggle">
                <span
                    :class="{ cur: theme == 'theme-default' }"
                    @click="changeTheme('theme-default')"
                    >浅</span
                >
                |
                <span
                    :class="{ cur: theme == 'theme-dark' }"
...
export default {
    ...
    methods: {
        ...
        setErrMsg() {
            this.loginRules.name[0].message = this.$t(
                "global.errMsg.inputRequired",
                { cont: this.$t("global.username") }
            );
            this.loginRules.password[0].message = this.$t(
                "global.errMsg.inputRequired",
